...
<div class="main">
  ...
  <div class="SearchBox" style="margin-left: 100px; height: 40px;">
    ...
    <el-button type="primary" plain style="margin-left: 70px; background-color: rgb(255, 255, 255); border-color: 2px solid #577797; color:#577797;height:40px" @click="Search()">搜索</el-button>
...
<div class="BoxRow">
<div v-for="(items,index) of  this.rowList.first " :key="currentDate[index].b_Id" :span="3" class="box1" @click="toDetail(index)">
            <div class="box">
...
<div v-for="(items,index) of  this.rowList.second " :key="currentDate[index+3].b_Id" :span="3" class="box1" @click="toDetail(index+3)">
            <div class="box">
              <img src="../../resource/temp1.jpg">
              <el-divider></el-divider>
...
<div v-for="(items,index) of  this.rowList.third " :key="currentDate[index+6].b_Id" :span="3" class="box1" @click="toDetail(index+6)">
            <div class="box">
              <img src="../../resource/temp1.jpg">
              <el-divider></el-divider>
...
<br><br>
<el-pagination background layout="prev, pager, next" :total=this.pageNum @current-change="handleCurrentChange"></el-pagination>
</div>
    </body>
</template>
  <script>
